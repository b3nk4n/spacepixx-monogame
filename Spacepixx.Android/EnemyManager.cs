    ...
    class EnemyManager : ILevel
    {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            foreach (var enemy in Enemies)
            {
                ...
                if (IsAngry)
                {
                    enemy.EnemySprite.TintColor = new Color((byte) 255, (byte) 128, (byte) 128, tint.A);
                }
                else if (IsFriendly)
                {
                    enemy.EnemySprite.TintColor = new Color((byte) 128, (byte) 255, (byte) 128, tint.A);
                }
        ...
        public void SetLevel(int lvl)
        {
            ...
            float tmp = (int)(InitialNextWaveMinTimer - (float)Math.Sqrt(lvl - 1) * 0.075f + 0.02 * (lvl - 1));
